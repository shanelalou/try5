...
<body>
		<div class="wraper">
			<div  style="font-size:15px"><?php header('Access-Control-Allow-Origin: http://gordoncollegeccs.edu.ph/'); echo $_SESSION['faculty'] ?> - <?php echo faculty($_SESSION['faculty'],'lastname').', '.faculty($_SESSION['faculty'],'firstname').' '.faculty($_SESSION['faculty'],'middlename').' - '.faculty($_SESSION['faculty'],'position') ?>
			</div>
		</div>
